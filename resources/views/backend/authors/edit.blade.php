            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit Author</h4>
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('backend.authors.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="authorImgPreview" src="{{ $author->image ? url('upload/author_images/' . $author->image) : asset('upload/no_image.jpg') }}" class="mt-2 rounded-circle border" style="width:100px;height:100px;object-fit:cover;">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Author Name <span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="author_name" class="form-control" value="{{ old('name', $author->name) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Slug <span class="text-danger">*</span></label>
                                    <input type="text" name="slug" id="author_slug" class="form-control" value="{{ old('slug', $author->slug) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" class="form-control" rows="4">{{ old('description', $author->description) }}</textarea>
                                </div>
                                ...
                                <button type="submit" class="btn btn-sm btn-primary px-4">
                                    <i class="bx bx-save me-1"></i> Update Author
                                </button>
                            </form>
                        </div>
                    </div>
