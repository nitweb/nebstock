...
<head>
    ...
    <title>Admin Dashboard | Nebstock</title>


    {{-- ==================== Favicon Icon ==================== --}}
    <link rel="shortcut icon"
        href="{{ asset('backend/assets/images/favicon.png') }}?v={{ filemtime(public_path('backend/assets/images/favicon.png')) }}">
    ...
    {{-- ==================== Bootstrap CSS ==================== --}}
    <link rel="stylesheet"
        href="{{ asset('backend/assets/css/bootstrap.min.css') }}?v={{ filemtime(public_path('backend/assets/css/bootstrap.min.css')) }}"
        id="bootstrap-style">


    {{-- ==================== Icons CSS ==================== --}}
    <link rel="stylesheet"
        href="{{ asset('backend/assets/css/icons.min.css') }}?v={{ filemtime(public_path('backend/assets/css/icons.min.css')) }}">


    {{-- ==================== App CSS ==================== --}}
    <link rel="stylesheet"
        href="{{ asset('backend/assets/css/app.min.css') }}?v={{ filemtime(public_path('backend/assets/css/app.min.css')) }}"
        id="app-style">
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/assets/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css') }}">
...
<body>
    ...
    {{-- ==================== App JS ==================== --}}
    <script src="{{ asset('backend/assets/js/app.js') }}?v={{ filemtime(public_path('backend/assets/js/app.js')) }}"></script>
