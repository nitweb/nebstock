                                ...
                                <div class="card shadow">
                                    <div class="card-body mb-4">
                                        ...
                                        <div class="text-center">
                                            <h5 class="mb-0">Set a New Password</h5>
                                            <p class="text-muted mt-2">Please enter your new password to reset your admin account.</p>
                                        </div>
                                        ...
                                        <form class="mt-4 pt-2" action="{{ route('admin.reset.password.submit') }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <input type="password" name="password_confirmation" class="form-control" placeholder="Enter confirm new password" aria-label="Password" aria-describedby="password-addon">
                                                    <button class="btn btn-light shadow-none password-addon ms-0" type="button"><i class="mdi mdi-eye-outline"></i></button>
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <button class="btn btn-primary w-100 waves-effect waves-light custom_site_btn" type="submit">Confirm</button>
                                            </div>
