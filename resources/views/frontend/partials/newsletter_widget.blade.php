<div class="footer__widget">
    ...
    <p class="footer__widget--desc">Subscribe to our weekly newsletter and be first to discover new arrivals, rare editions, and exclusive reading lists.</p>

    <div class="newsletter__subscribe footer__newsletter">
        <form class="newsletter__subscribe--form" id="footerNewsletterForm" novalidate>
            @csrf
            <label>
                <input class="newsletter__subscribe--input" id="footerNewsletterEmail" placeholder="Enter your email address" type="email" autocomplete="email">
            </label>
            <button class="newsletter__subscribe--button" type="submit" id="footerNewsletterBtn">
                <span class="nl-btn-text">Subscribe</span>
                <span class="nl-btn-loader" style="display:none;">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="animation:nl-spin .7s linear infinite;">
    ...
    <ul class="social__share footer__social">
        <li class="social__share--list">
            <a class="social__share--icon" target="_blank" href="https://www.facebook.com/" aria-label="Facebook">
                <svg width="10" height="17" viewBox="0 0 9 15" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="social__share--list">
            <a class="social__share--icon" target="_blank" href="https://twitter.com/" aria-label="Twitter">
                <svg width="16" height="14" viewBox="0 0 14 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="social__share--list">
            <a class="social__share--icon" target="_blank" href="https://www.instagram.com/" aria-label="Instagram">
                <svg width="16" height="15" viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="social__share--list">
            <a class="social__share--icon" target="_blank" href="https://www.pinterest.com/" aria-label="Pinterest">
                <svg width="14" height="17" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg">
...
<style>
    ...
    .newsletter__subscribe--input.nl-invalid {
        border-color: #ff6b81 !important;
        outline-color: #ff6b81 !important;
    }
