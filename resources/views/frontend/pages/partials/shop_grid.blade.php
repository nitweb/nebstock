...
@empty
    <div class="col-12 text-center py-5">
        <img src="{{ asset('upload/no_image.jpg') }}" style="width:80px;opacity:.4;" class="mb-3">
        <p class="text-muted">No products found matching your filters.</p>
        <a href="{{ route('shop') }}" class="primary__btn" style="display:inline-block;margin-top:8px;">Clear Filters</a>
    </div>
@endforelse
