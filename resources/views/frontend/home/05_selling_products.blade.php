    ...
    <div class="container container-two">
        ...
        <div class="selling-product-slider">
            ...
            <div class="product-item shadow-sm overlay-none">
                ...
                <div class="product-item__content">
                    <h6 class="product-item__title">
                        <a href="javascript:void(0)" class="link">Title here digital products new marketplace theme</a>
                    </h6>
                    ...
                    <div class="product-item__bottom flx-between gap-2">
                        ...
                        <div class="flx-align gap-2">
                            ...
                            <a href="javascript:void(0)" class="btn btn-outline-light pill">Live Demo</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-item shadow-sm overlay-none">
                <div class="product-item__thumb d-flex max-h-unset">
                    <a href="javascript:void(0)" class="link w-100">
                        <img src="{{ asset('frontend/assets/images/thumbs/product-img13.png') }}" alt="" class="cover-img">
                    </a>
                </div>
                <div class="product-item__content">
                    <h6 class="product-item__title">
            ...
            <div class="product-item shadow-sm overlay-none">
                <div class="product-item__thumb d-flex max-h-unset">
                    <a href="javascript:void(0)" class="link w-100">
                        <img src="{{ asset('frontend/assets/images/thumbs/product-img14.png') }}" alt="" class="cover-img">
                    </a>
                </div>
                <div class="product-item__content">
                    <h6 class="product-item__title">
