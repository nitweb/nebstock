<section class="feature__section section--padding" style="background-color: #f8f9fa;">
    <div class="container">
        <div class="feature__inner d-flex justify-content-between">
            <div class="feature__items d-flex align-items-center">
                <div class="feature__icon">
                    <img src="{{ asset('frontend/assets/img/other/feature1.webp') }}" alt="img">
                </div>
            ...
            <div class="feature__items d-flex align-items-center">
                <div class="feature__icon ">
                    <img src="{{ asset('frontend/assets/img/other/feature2.webp') }}" alt="img">
                </div>
                <div class="feature__content">
            ...
            <div class="feature__items d-flex align-items-center">
                <div class="feature__icon">
                    <img src="{{ asset('frontend/assets/img/other/feature3.webp') }}" alt="img">
                </div>
                <div class="feature__content">
            ...
            <div class="feature__items d-flex align-items-center">
                <div class="feature__icon">
                    <img src="{{ asset('frontend/assets/img/other/feature4.webp') }}" alt="img">
                </div>
                <div class="feature__content">
