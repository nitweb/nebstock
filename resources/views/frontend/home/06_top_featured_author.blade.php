                ...
                <div class="section-content">
                    ...
                    <div class="author-info d-flex align-items-center gap-3">
                        <div class="author-info__thumb">
                            <img src="{{ $top_author && $top_author->image ? asset('upload/author_images/' . $top_author->image) : asset('frontend/assets/images/thumbs/author-img.png') }}" alt="{{ $top_author->name ?? 'Author' }}">
                        </div>
